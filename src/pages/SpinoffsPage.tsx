...
import { ExternalLink, Rocket, Brain, Shield, ArrowRight, HeartPulse, Bike, Globe } from 'lucide-react';
...
const SpinoffsPage: React.FC = () => {
  const companies = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200&h=800&fit=crop&auto=format&q=80',
      highlights: [
      ...
      bgColorClass: 'bg-gradient-to-br from-purple-500/10 to-blue-500/10'
    },
    {
    ...
    {
      name: 'GO VV',
      tagline: 'Pioneering the Next-Gen Tech Ecosystem',
  ...
  // Migration section data
  const migrationCompany = {
    name: 'Migration',
    tagline: 'Seamless and Efficient Migration Solutions',
    description: 'Focused on providing end-to-end migration solutions for businesses and applications. Our expertise ensures smooth transitions with minimal downtime, data integrity, and optimized performance across platforms.',
    ...
    bgColorClass: 'bg-gradient-to-br from-indigo-500/10 to-cyan-500/10'
  };
      ...
      <div className="min-h-screen">
        ...
        <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-primary/10 via-background to-accent/5">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            <SectionHeading
              title={<>Our <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Spinoffs</span></>}
              subtitle="Where Innovation Takes Flight"
              centered={true}
            />
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-background">
          <div className="max-w-7xl mx-auto space-y-24">
            {[...companies, migrationCompany].map((company, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center ${isEven ? '' : 'lg:grid-flow-col-dense'}`}>
                    <div className={`${isEven ? '' : 'lg:col-start-2'}`}>
                      ...
                      <p className="text-lg text-muted-foreground leading-relaxed mt-6">{company.description}</p>
                      ...
                      <div className="mt-10">
                        {company.website ? (
                          <a
                            ...
                            className={`inline-flex items-center justify-center gap-2 h-11 px-8 rounded-md text-sm font-medium text-white bg-gradient-to-r ${company.color} hover:shadow-xl transition-all`}
                          >
                            Visit Website
                          ...
                          <Button
                            size="lg"
                            disabled
                            className="opacity-60 bg-gradient-to-r from-gray-400 to-gray-500 text-white"
                          >
                            Coming Soon
