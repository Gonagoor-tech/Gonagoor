...
const items = [
  { id: 1, title: "DPIIT Recognised Defence Startup", img: `${import.meta.env.BASE_URL}public/Images/certificate1.jpg`, desc: "Recognised by the Department for Promotion of Industry and Internal Trade (DPIIT) as an authorised defence startup, validating our innovation, credibility, and contribution to India’s strategic technology ecosystem." },
  { id: 2, title: "Product launch at Bengaluru Tech Summit 2025", img: `${import.meta.env.BASE_URL}public/Images/productBts.jpg`, desc: "Officially unveiled our flagship product at the prestigious Bengaluru Tech Summit 2025, showcasing breakthrough innovation to global industry leaders, investors, and technology partners." },
  { id: 3, title: "Completed assembly of indigenously developed jet engine", img: `${import.meta.env.BASE_URL}public/Images/jet.jpg`, desc: "Successfully completed the full assembly of our in-house developed jet engine, marking a major milestone toward testing and validation of India’s next-generation propulsion technology." },
  { id: 4, title: "DRDO collaboration in progress for M.A.L.E UAV", img: `${import.meta.env.BASE_URL}public/Images/drdo.jpg`, desc: "Currently collaborating with DRDO on next-generation Medium Altitude Long Endurance UAV development." },
  { id: 5, title: "Tight GTRE collaboration for engine requirements of Indian Defence", img: `${import.meta.env.BASE_URL}public/Images/Gt.jpg`, desc: "Working closely with GTRE to develop and supply advanced propulsion systems for strategic defence applications." },
  // Highlight Gonagoor partnership explicitly
  { id: 6, title: "Gonagoor Technologies — R&D & Pre-seed Support", img: `${import.meta.env.BASE_URL}public/Images/gonagoor.jpg`, desc: "Backed by Gonagoor Technologies with dedicated R&D collaboration and pre-seed funding to accelerate our propulsion and aerospace product roadmap. This strategic support helps us move from prototype to test campaigns." },
  { id: 7, title: "Elevate 2025 Finalist", img: `${import.meta.env.BASE_URL}public/Images/elevate.jpg`, desc: "Recognized among the top startups in Elevate 2025 for innovation and technological impact." },
  { id: 8, title: "InSpace validated design of satellites", img: `${import.meta.env.BASE_URL}public/Images/inspace.jpg`, desc: "Our satellite design successfully passed InSpace validation, demonstrating reliability and readiness for space applications." },
  { id: 9, title: "South Park Commons Demo Night Finalists 2025", img: `${import.meta.env.BASE_URL}public/Images/south.jpg`, desc: "Selected as finalists at the South Park Commons Demo Night 2025 for breakthrough technology demonstration." },
  { id: 10, title: "2400°C temperature on off-the-shelf aluminium — a world record", img: `${import.meta.env.BASE_URL}public/Images/2000.jpg`, desc: "Achieved a world-record 2400°C temperature endurance using standard aluminium through proprietary engineering and thermal R&D." },
];
