...
<<<<<<< HEAD
  ...
  {
    icon: <Lightbulb className="w-6 h-6" />,
    title: "Kiranalekha - Photolithography",
    description: "Next generation of portable sustainable photography devices. ",
    
    color: "from-yellow-500/20 to-mustard-500/20"
  },
  {
    icon: <Monitor className="w-6 h-6" />,
    title: "Maaya Drushti",
    description: "Augmented reality integration into the sudarshana platform for realistic augmented vision to all including visually challenged.",
