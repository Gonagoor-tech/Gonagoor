...
const Navbar: React.FC = () => {
  ...
  const divisionItems = [
    ...
    { title: "Healthcare", path: "/healthcare", description: "Digital health, medtech, and clinical AI solutions" }
  ];
            ...
            >
              <button
                ...
                className={cn(
                  ...
                  "after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-primary after:transition-all after:duration-300",
                  "hover:after:w-3/4",
                  (location.pathname === "/aerospace" || location.pathname === "/ai" || location.pathname === "/software" || location.pathname === "/mobility" || location.pathname === "/healthcare" || isDivisionsOpen)
                    ? "text-primary after:w-3/4"
                    : "text-foreground/80 hover:text-primary"
                )}
